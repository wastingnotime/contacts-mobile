...
- The slice implementation matches the refined intent: contact detail is repository-owned BFF-backed, `GET /api/contacts/{id}` is loaded explicitly, and the UI renders loading, loaded, not-found, and error outcomes.
