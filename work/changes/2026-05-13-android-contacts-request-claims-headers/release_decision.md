...
- The slice implementation matches the refined intent: every contacts API request carries explicit claims headers, build-time configuration stays admin-shaped for local use, and blank claims fail early.
